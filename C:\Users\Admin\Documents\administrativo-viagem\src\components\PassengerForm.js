  ...
  return (
    <div className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-xl rounded-3xl p-8 shadow-xl border border-white/20 dark:border-slate-700/50">
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          onClick={onCancel}
          className="p-2 hover:bg-red-100 dark:hover:bg-red-900/50 rounded-xl transition-colors text-gray-800 dark:text-gray-200"
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            <label htmlFor="cpf" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">CPF *</label>
            <input
          ...
          <div>
            <label htmlFor="dataNascimento" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Data de Nascimento *</label>
            <input
          ...
          <div className="md:col-span-2">
            <label htmlFor="email" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Email (Opcional)</label>
            <input
          ...
          <div>
            <label htmlFor="phone" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Telefone (Opcional)</label>
            <input
        ...
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-slate-800 dark:to-gray-800 rounded-2xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
               <div>
                ...
                <div>
                  ...
                  <div className="p-3 bg-gray-100 dark:bg-slate-800 rounded-lg w-full text-gray-800 dark:text-gray-100 font-medium">
            ...
            <div className="col-span-1 md:col-span-2 lg:grid-cols-3 mt-2 mb-3">
              <label htmlFor="incluirVolta" className="flex items-center space-x-2 cursor-pointer">
                <input
                  ...
                  className="rounded text-blue-600 focus:ring-blue-500 h-4 w-4 border-gray-300 dark:border-slate-500 bg-slate-700"
                />
                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Haverá volta? (duplicar invertendo origem/destino)</span>
              </label>
            </div>
          ...
          {currentPassageiro.itinerarios && currentPassageiro.itinerarios.map((itinerario, index) => (
            <div key={itinerario.id || index} className="bg-white dark:bg-slate-700 rounded-xl p-4 mb-2 flex items-center justify-between">
        ...
        <div className="bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-slate-800 dark:to-gray-800 rounded-2xl p-6">
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4 flex items-center space-x-2">
            ...
            <div>
                <label
                    ...
                    className="w-full flex items-center justify-center px-4 py-6 border-2 border-dashed border-gray-300 dark:border-slate-600 rounded-xl cursor-pointer hover:border-purple-500 dark:hover:border-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-colors"
                >
                    <div className="text-center">
                        <p className="text-sm text-gray-600 dark:text-gray-300">Adicionar anexos para este passageiro</p>
                        <p className="text-xs text-gray-500 dark:text-gray-400">Anexe a Imagem</p>
                    </div>
                    <input
                        ...
                        {currentPassageiro.anexos.map((file, index) => (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="p-1 hover:bg-red-100 dark:hover:bg-red-900/50 rounded-md transition-colors text-gray-800 dark:text-gray-200"
                                    title="Remover anexo"
                                >
                                    <span>X</span>
                                </button>
